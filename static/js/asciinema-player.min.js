var AsciinemaPlayer = (function (A) {
  ...
  function V() {
    return (
      (null !== E && 0 !== E.byteLength) ||
        (E = new Uint8Array(Q.memory.buffer)),
      E
    );
  }
  function i(A, g) {
    return (A >>>= 0), C.decode(V().subarray(A, A + g));
  }
  const e = new Array(128).fill(void 0);
  e.push(void 0, null, !0, !1);
  let o = e.length;
  function t(A) {
    o === e.length && e.push(e.length + 1);
    const g = o;
    return (o = e[g]), (e[g] = A), g;
  }
  function s(A) {
    return e[A];
  }
  ...
  function h() {
    return (
      (null !== l && 0 !== l.byteLength) ||
        (l = new Int32Array(Q.memory.buffer)),
      l
    );
  }
  let y = null;
  ...
  class F {
    static __wrap(A) {
      ...
      return (g.__wbg_ptr = A), k.register(g, g.__wbg_ptr, g), g;
    }
    __destroy_into_raw() {
    ...
    feed(A) {
      const g = w(A, Q.__wbindgen_malloc, Q.__wbindgen_realloc),
        I = a;
      return n(Q.vt_feed(this.__wbg_ptr, g, I));
    }
    resize(A, g) {
      return n(Q.vt_resize(this.__wbg_ptr, A, g));
    }
    inspect() {
      let A, g;
      try {
    ...
    getLine(A) {
      return n(Q.vt_getLine(this.__wbg_ptr, A));
    }
    getCursor() {
      return n(Q.vt_getCursor(this.__wbg_ptr));
    }
  }
  function N() {
    const A = { wbg: {} };
  ...
  var J = Object.freeze({
    ...
    initSync: function (A) {
      ...
      return (
        ...
        q(new WebAssembly.Instance(A, g), A)
      );
    },
  });
  const d = [
  ...
  const u = (function (A) {
    ...
    for (let I = 0, C = 0; I < B; I += 4, C += 3)
      (g =
        (M(A.charCodeAt(I)) << 18) |
        (M(A.charCodeAt(I + 1)) << 12) |
        (M(A.charCodeAt(I + 2)) << 6) |
        M(A.charCodeAt(I + 3))),
        (Q[C] = g >> 16),
        (Q[C + 1] = (g >> 8) & 255),
        (Q[C + 2] = 255 & g);
  ...
  class Y {
    ...
    multiplex(A, g) {
      return new Y(new L(this[Symbol.iterator](), A[Symbol.iterator](), g));
    }
    toArray() {
  ...
  async function p(A) {
    if (A instanceof Response) {
      ...
      if (void 0 !== I) {
        const { header: A, events: g } = I;
        if (2 === A.version) return H(A, g);
        if (3 === A.version) return m(A, g);
        throw `asciicast v${A.version} format not supported`;
      }
      {
        const A = JSON.parse(g);
        if (1 === A.version) return K(A);
      }
    } else {
      if ("object" == typeof A && 1 === A.version) return K(A);
      if (Array.isArray(A)) {
        const g = A[0];
        if (2 === g.version) {
          return H(g, A.slice(1, A.length));
        }
        if (3 === g.version) {
          return m(g, A.slice(1, A.length));
        }
  ...
  function m(A, g) {
    g instanceof Y || (g = new Y(g));
    let I = 0;
    return (
      (g = g.map((A) => ((I += A[0]), [I, A[1], A[2]]))),
      {
        cols: A.term.cols,
        rows: A.term.rows,
        theme: b(A.term?.theme),
        events: g,
        idleTimeLimit: A.idle_time_limit,
      }
    );
  ...
  function b(A) {
    ...
    return g.test(I) &&
      ...
      ? { foreground: I, background: B, palette: Q.split(":") }
      : void 0;
  }
  function v(A) {
  ...
  function O(A, g, I, B, Q, C, E, V, i) {
    const e = (function (A, g, I, B) {
      return function (Q, C) {
        "o" === Q
          ? A(C)
          : "i" === Q
      ...
      );
    {
      ...
      return (
        "number" == typeof (A = A ?? {})
          ? (i.debug(`using fixed time buffer (${A} ms)`), (g = (g) => A))
          : "function" == typeof A
            ? (i.debug("using custom dynamic buffer"), (g = A({ logger: i })))
            : (i.debug("using adaptive buffer", A),
              (g = (function (A, g) {
                ...
                return (A) => {
                  if ((t.push(A), t.length < E)) return o;
                  t = t.slice(-E);
                  const g = t.reduce((A, g) => (g < A ? g : A));
                  const B = (function (A) {
                  ...
                  else if ((e > 1 && C < a(e - 2)) || (1 == e && C < a(e - 1)))
                    return (
                      null === r
                        ? (r = performance.now())
                        : performance.now() - r > i &&
  ...
  function Z(A) {
    ...
    let B,
      ...
      C = 0;
    function E(A) {
      const g = new _(new DataView(A)),
        I = g.getUint8();
      if (1 !== I) throw `expected reset (0x01) frame, got ${I}`;
      return V(g, A);
    }
    function V(A, I) {
      A.decodeVarUint();
      let E = A.decodeVarUint();
      (B = E), (E /= j), (C = 0);
      ...
      if (8 === o) {
        const g = 30;
        (t = X(new Uint8Array(I, A.offset, g))), A.forward(g);
      } else if (16 === o) {
        const g = 54;
        (t = X(new Uint8Array(I, A.offset, g))), A.forward(g);
      } else if (0 !== o) throw `alis: invalid theme format (${o})`;
      const s = A.decodeVarUint();
      let n;
      return (
        s > 0 && (n = g.decode(new Uint8Array(I, A.offset, s))),
        (Q = i),
        { time: E, term: { size: { cols: V, rows: e }, theme: t, init: n } }
      );
    }
    function i(i) {
      const e = new _(new DataView(i)),
        o = e.getUint8();
      return 1 === o
        ? V(e, i)
        : 111 === o
          ? (function (A, I) {
              ...
              const C = A.decodeVarUint(),
                E = g.decode(new Uint8Array(I, A.offset, C));
              return [B / j, "o", E];
            })(e, i)
          : 105 === o
            ? (function (A, g) {
                ...
                B += Q;
                const C = A.decodeVarUint(),
                  E = I.decode(new Uint8Array(g, A.offset, C));
                return [B / j, "i", E];
              })(e, i)
            : 114 === o
              ? (function (A) {
                  ...
                  B += g;
                  const I = A.decodeVarUint(),
                    Q = A.decodeVarUint();
                  return [B / j, "r", { cols: I, rows: Q }];
                })(e)
              : 109 === o
                ? (function (A, g) {
                    A.decodeVarUint();
                    ...
                    const Q = A.decodeVarUint(),
                      ...
                      V = C++,
                      i = B / j,
                      e = E.decode(new Uint8Array(g, A.offset, Q));
                    return [i, "m", { index: V, time: i, label: e }];
                  })(e, i)
                : 4 === o
                  ? ((Q = E), !1)
                  : void A.debug(`alis: unknown frame type: ${o}`);
    }
    return function (A) {
      return Q(A);
    };
  ...
  function X(A) {
    const g = A.length / 3,
      ...
      B = P(A[3], A[4], A[5]),
      Q = [];
    for (let I = 2; I < g; I++) Q.push(P(A[3 * I], A[3 * I + 1], A[3 * I + 2]));
  ...
  function $() {
    ...
    let g = function (B) {
      ...
      return (
        (g = I), { time: 0, term: { size: { cols: C, rows: E }, init: Q } }
      );
    };
    function I(g) {
  ...
  class sA {
      ...
      (this.logger = I.logger),
        ...
        (this.driver = (function (A) {
          ...
          if (
            ...
            if (!rA.has(A.parser)) throw `unknown parser: ${A.parser}`;
            A.parser = rA.get(A.parser);
          }
          if (nA.has(A.driver)) {
            const g = nA.get(A.driver);
            return (I, B) => g(A, I, B);
          }
    ...
    async init() {
      ...
      if (
        ...
        let g = new U();
        (this.driver.play = () => ((g = new f(this.speed)), A())),
          (this.driver.getCurrentTime = () => g.getTime());
      }
      this._dispatchEvent("ready", V), this.autoPlay && this.play();
    }
    play() {
    ...
    _setState(A) {
      ...
      if (((this.stateName = A), "playing" === A)) this.state = new VA(this);
      else if ("idle" === A) this.state = new EA(this);
      else if ("loading" === A) this.state = new iA(this);
      else if ("ended" === A) this.state = new oA(this);
    ...
    async _initializeDriver() {
      ...
      const g = void 0 !== A.poster ? this._renderPoster(A.poster) : null;
      ...
      let I =
        ...
        B =
          arguments.length > 3 && void 0 !== arguments[3]
            ? arguments[3]
            : void 0;
      this.logger.debug(`core: vt reset (${A}x${g})`),
        (this.cols = A),
        (this.rows = g),
        (this.cursor = void 0),
  ...
  const nA = new Map([
        ...
        function (A, g) {
          ...
          return {
            async init() {
              ...
              for (const [A, g] of I) i += new Blob([g]).size;
      ...
      [
        ...
        function (A, g, I) {
          ...
          return {
            init: () => {
              const A = [t].concat(n());
              return { cols: V, rows: i, duration: 1440, poster: A };
            },
            play: () => (E(t), r(), (s = setInterval(r, 1e3)), !0),
            stop: () => {
              clearInterval(s);
            },
            getCurrentTime: () => {
      ...
      [
        ...
        function (A, g) {
          ...
          r = new B(r, "eventsource: ");
          let a = new U();
          function c(A) {
            void 0 !== Q && Q.stop(),
              (Q = O(E, i, o, t, s, (A) => a.setTime(A), A, V, r));
          }
          return {
            play: () => {
              (I = new EventSource(C)),
                ...
                I.addEventListener("error", (A) => {
                  r.info("errored"), r.debug({ e: A }), n("loading");
                }),
                I.addEventListener("message", (A) => {
                  ...
                  if (Array.isArray(g)) Q.pushEvent(g);
                    ...
                    const A = g.cols ?? g.width,
                      I = g.rows ?? g.height;
                    r.debug(`vt reset (${A}x${I})`),
                      n("playing"),
                      c(g.time),
                      e(A, I, g.init ?? void 0),
                      (a = new f()),
                      "number" == typeof g.time && a.setTime(g.time);
                  } else
                    "offline" === g.state &&
                      (r.info("stream offline"),
        ...
        function (A, g, I) {
          ...
          function L(A) {
            ...
            if ("o" === I) s(B);
              ...
              return K(), (t = 1e3 * g), w("idle", { reason: "paused" }), !0;
            return !1;
          }
          function p() {
            S(),
              M++,
              !0 === G || ("number" == typeof G && M < G)
                ? ((J = 0), (o = c()), s("c"), x(), f())
                : ((t = 1e3 * V), w("ended"));
          }
          function K() {
          ...
          function m(A) {
            ...
            let Q = C[J];
            for (; Q && Q[0] <= B; )
              ("o" !== Q[1] && "r" !== Q[1]) || L(Q), (d = Q[0]), (Q = C[++J]);
            return (t = 1e3 * B), (i = null), g && H(), !0;
          }
          function b(A) {
            if (0 == E.length) return;
            let g,
          ...
          return {
              ...
              const {
                ...
                s = (function (A, g, I) {
                  ...
                  const o = i[i.length - 1][0],
                    t = B - e.offset;
                  return { ...A, events: i, duration: o, effectiveStartAt: t };
                })(
                  await g(
                    await (function (A) {
                      let { url: g, data: I, fetchOpts: B = {} } = A;
                      if ("string" == typeof g) return u(g, B);
                      if (Array.isArray(g))
                        return Promise.all(g.map((A) => u(A, B)));
                      if (void 0 !== I)
                        return (
            ...
            play: function () {
              if (e) throw "already playing";
              if (void 0 === C[J]) throw "already ended";
              return null !== i && m(i), H(), !0;
            },
            pause: K,
            seek: m,
            step: function (A) {
            ...
            restart: function () {
              if (e) throw "still playing";
              if (void 0 !== C[J]) throw "not ended";
              return m(0), H(), !0;
            },
            stop: K,
            getCurrentTime: function () {
              return e ? (c() - o) / 1e3 : (t ?? 0) / 1e3;
            },
          };
        },
      ],
      [
        ...
        function (A, g) {
          ...
          function G() {
            (I = new WebSocket(C, ["v1.alis", "v2.asciicast", "raw"])),
              ...
              (I.onopen = () => {
                ...
                a.info("opened"),
                  a.info(`activating ${A} protocol handler`),
                  "v1.alis" === A
                    ? (I.onmessage = k(Z(a)))
                    : "v2.asciicast" === A
                      ? (I.onmessage = k(
              ...
              (I.onclose = (A) => {
                if (
                  (clearTimeout(D), q(), h || 1e3 === A.code || 1005 === A.code)
                )
                  a.info("closed"), r("ended", { message: "Stream ended" });
                else if (1002 === A.code)
                  a.debug(`close reason: ${A.reason}`),
                    r("ended", {
                  ...
                  clearTimeout(c);
                  const A = V(l++);
                  a.info(`unclean close, reconnecting in ${A}...`),
                    r("loading"),
                    setTimeout(G, A);
                }
              }),
              ...
              function (g) {
                try {
                  ...
                  if (Q)
                    ...
                    clearTimeout(D), (D = setTimeout(N, 1e3));
                  } else F(I), clearTimeout(D);
                } catch (A) {
                  throw (I.close(), A);
                }
              }
          ...
          function F(A) {
            let { time: g, term: I } = A;
            const { size: B, init: C, theme: V } = I,
              { cols: c, rows: D } = B;
            a.info(`stream reset (${c}x${D} @${g})`),
              r("playing"),
              q(),
              (Q = O(E, e, t, s, n, (A) => w.setTime(A), g, i, a)),
              o(c, D, C, V),
              (w = new f()),
              (y = !0),
              "number" == typeof g && w.setTime(g);
          }
          function N() {
            q(),
              y
                ? (a.info("stream ended"),
                  r("offline", { message: "Stream ended" }))
          ...
          return {
            ...
            stop: () => {
              (h = !0), q(), void 0 !== I && I.close();
            },
            getCurrentTime: () => w.getTime(),
          };
        },
      ],
    ]),
      ...
      [
        ...
        async function (A, g) {
          ...
          const V = await A[1].arrayBuffer(),
            i = new Uint8Array(V),
            e = i.findIndex((A) => 10 == A) + 1,
            o = B.decode(i.subarray(0, e)).match(
              /COLUMNS="(\d+)" LINES="(\d+)"/,
            );
          null !== o && ((Q = parseInt(o[1], 10)), (C = parseInt(o[2], 10)));
          const t = { array: i, cursor: e };
          let s = t;
          if (void 0 !== A[2]) {
            const g = await A[2].arrayBuffer();
            s = { array: new Uint8Array(g), cursor: e };
          }
          const n = [];
          let r = 0;
          for (const A of E)
            if (((r += parseFloat(A[1])), "O" === A[0])) {
              const g = parseInt(A[2], 10),
                I = t.array.subarray(t.cursor, t.cursor + g),
                Q = B.decode(I);
              n.push([r, "o", Q]), (t.cursor += g);
            } else if ("I" === A[0]) {
              const g = parseInt(A[2], 10),
          ...
          return (Q = Q ?? 80), (C = C ?? 24), { cols: Q, rows: C, events: n };
        },
      ],
      [
        "ttyrec",
        async function (A, g) {
          ...
          let o = 80,
            t = 24;
          null !== i && ((o = parseInt(i[2], 10)), (t = parseInt(i[1], 10)));
          let s = 0,
            n = gA(C);
          for (; void 0 !== n; ) {
            const A = n.time - V,
              g = B.decode(n.data);
            e.push([A, "o", g]), (s += n.len), (n = gA(C.subarray(s)));
          }
          return { cols: o, rows: t, events: e };
        },
      ],
    ]);
  const aA = Symbol("solid-proxy"),
    cA = "function" == typeof Proxy,
    DA = Symbol("solid-track"),
    wA = { equals: (A, g) => A === g };
  let lA = OA;
  const hA = 1,
    yA = 2,
    GA = { owned: null, cleanups: null, context: null, owner: null };
  var kA = null;
  let FA = null,
    NA = null,
    qA = null,
  ...
  function MA(A, g) {
    const I = {
      ...
      observers: null,
      observerSlots: null,
      comparator: (g = g ? Object.assign({}, wA, g) : wA).equals || void 0,
    };
    return [
      HA.bind(I),
      (A) => ("function" == typeof A && (A = A(I.value)), mA(I, A)),
    ];
  }
  function uA(A, g, I) {
    bA(vA(A, g, !1, hA));
  ...
  function SA(A) {
    !(function (A, g, I) {
      lA = WA;
      const B = vA(A, g, !1, hA);
      (I && I.render) || (B.user = !0), RA ? RA.push(B) : bA(B);
    })(() => YA(A));
  }
  function LA(A) {
    return (
      null === kA ||
        (null === kA.cleanups ? (kA.cleanups = [A]) : kA.cleanups.push(A)),
      A
    );
  }
  function pA() {
  ...
  function HA() {
    if (this.sources && this.state)
      if (this.state === hA) bA(this);
      else {
        const A = qA;
        (qA = null), xA(() => jA(this), !1), (qA = A);
      }
    if (NA) {
      const A = this.observers ? this.observers.length : 0;
      NA.sources
        ? (NA.sources.push(this), NA.sourceSlots.push(A))
        : ((NA.sources = [this]), (NA.sourceSlots = [A])),
        this.observers
          ? (this.observers.push(NA),
            this.observerSlots.push(NA.sources.length - 1))
          : ((this.observers = [NA]),
            (this.observerSlots = [NA.sources.length - 1]));
    }
    return this.value;
  }
  function mA(A, g, I) {
        ...
        A.observers &&
          ...
          xA(() => {
            for (let g = 0; g < A.observers.length; g += 1) {
              ...
              B && FA.disposed.has(I),
                (B ? I.tState : I.state) ||
                  (I.pure ? qA.push(I) : RA.push(I), I.observers && ZA(I)),
                B || (I.state = hA);
            }
            if (qA.length > 1e6) throw ((qA = []), new Error());
          }, !1)),
      g
    );
  }
  function bA(A) {
    ...
    !(function (A, g, I) {
      ...
      try {
        ...
        return (
          A.pure &&
            ((A.state = hA), A.owned && A.owned.forEach(XA), (A.owned = null)),
          (A.updatedAt = I + 1),
          PA(g)
        );
      } finally {
      ...
      (!A.updatedAt || A.updatedAt <= I) &&
        (null != A.updatedAt && "observers" in A ? mA(A, B) : (A.value = B),
        (A.updatedAt = I));
    })(A, A.value, g);
  }
  function vA(A, g, I, B = hA, Q) {
    const C = {
      fn: A,
      state: B,
      updatedAt: null,
      ...
      value: g,
      owner: kA,
      context: kA ? kA.context : null,
      pure: I,
    };
    return (
      null === kA ||
        (kA !== GA && (kA.owned ? kA.owned.push(C) : (kA.owned = [C]))),
      C
    );
  }
  function TA(A) {
    if (0 === A.state) return;
    if (A.state === yA) return jA(A);
    if (A.suspense && YA(A.suspense.inFallback))
      return A.suspense.effects.push(A);
    const g = [A];
    for (; (A = A.owner) && (!A.updatedAt || A.updatedAt < JA); )
      A.state && g.push(A);
    for (let I = g.length - 1; I >= 0; I--)
      if ((A = g[I]).state === hA) bA(A);
      else if (A.state === yA) {
        const I = qA;
        (qA = null), xA(() => jA(A, g[0]), !1), (qA = I);
      }
  }
  function xA(A, g) {
    if (qA) return A();
    ...
    try {
      ...
      return (
        (function (A) {
          ...
          if (A) return;
          const g = RA;
          (RA = null), g.length && xA(() => lA(g), !1);
        })(I),
        g
      );
    } catch (A) {
      I || (RA = null), (qA = null), PA(A);
    }
  }
  function OA(A) {
    for (let g = 0; g < A.length; g++) TA(A[g]);
  }
  function WA(A) {
    let g,
      I = 0;
  ...
  function jA(A, g) {
    ...
    for (let I = 0; I < A.sources.length; I += 1) {
      ...
      if (B.sources) {
        const A = B.state;
        A === hA
          ? B !== g && (!B.updatedAt || B.updatedAt < JA) && TA(B)
          : A === yA && jA(B, g);
      }
    }
  }
  ...
  function XA(A) {
    ...
    if (A.tOwned) {
      for (g = A.tOwned.length - 1; g >= 0; g--) XA(A.tOwned[g]);
      delete A.tOwned;
    }
    if (A.owned) {
      for (g = A.owned.length - 1; g >= 0; g--) XA(A.owned[g]);
      A.owned = null;
    }
    if (A.cleanups) {
      for (g = A.cleanups.length - 1; g >= 0; g--) A.cleanups[g]();
      A.cleanups = null;
    }
    A.state = 0;
  }
  ...
  function zA(A) {
    if ("function" == typeof A && !A.length) return zA(A());
    if (Array.isArray(A)) {
      const g = [];
  ...
  const Ig = {
    get: (A, g, I) => (g === aA ? I : A.get(g)),
    has: (A, g) => g === aA || A.has(g),
    set: gg,
    deleteProperty: gg,
  ...
  function Qg() {
    for (let A = 0, g = this.length; A < g; ++A) {
      const g = this[A]();
      if (void 0 !== g) return g;
    }
  }
  const Cg = (A) => `Stale read from <${A}>.`;
  function Eg(A) {
              ...
              YA(() => {
                ...
                if (0 === t)
                  ...
                  for (
                    ...
                    (n[w] = Q[D]), (r[w] = C[D]), V && (a[w] = V[D]);
                  for (A = new Map(), g = new Array(w + 1), e = w; e >= c; e--)
                    (l = o[e]),
                      (i = A.get(l)),
                      (g[e] = void 0 === i ? -1 : i),
                      A.set(l, e);
  ...
  function ig(A) {
    const g = A.keyed,
      I = fA(() => A.when, void 0, void 0),
      B = g ? I : fA(I, void 0, { equals: (A, g) => !A == !g });
    return fA(
      () => {
        const Q = B();
        if (Q) {
          const C = A.children;
          return "function" == typeof C && C.length > 0
            ? YA(() =>
                C(
                  g
                    ? Q
                    : () => {
                        if (!YA(B)) throw Cg("Show");
                        return I();
                      },
                ),
              )
  ...
  function eg(A) {
      ...
      I = fA(() => {
        ...
        for (let A = 0; A < I.length; A++) {
          const g = A,
            Q = I[A],
            C = B,
            E = fA(() => (C() ? void 0 : Q.when), void 0, void 0),
            V = Q.keyed ? E : fA(E, void 0, { equals: (A, g) => !A == !g });
          B = () => C() || (V() ? [g, E, Q] : void 0);
        }
        return B;
      });
    return fA(
      () => {
        ...
        const [B, Q, C] = g,
          E = C.children;
        return "function" == typeof E && E.length > 0
          ? YA(() =>
              E(
                C.keyed
                  ? Q()
                  : () => {
                      if (YA(I)()?.[0] !== B) throw Cg("Match");
                      return Q();
                    },
              ),
            )
  ...
  const tg = "_$DX_DELEGATE";
  function sg(A, g, I, B = {}) {
    let Q;
    return (
      dA((B) => {
        (Q = B),
          g === document ? A() : lg(g, A(), g.firstChild ? null : void 0, I);
      }, B.owner),
      () => {
        Q(), (g.textContent = "");
      }
  ...
  function ng(A, g, I, B) {
    ...
    const C = () => {
        ...
        return (
          (g.innerHTML = A),
          I
            ? g.content.firstChild.firstChild
            : B
              ? g.firstChild
              : g.content.firstChild
        );
      },
      E = g
        ? () => YA(() => document.importNode(Q || (Q = C()), !0))
        : () => (Q || (Q = C())).cloneNode(!0);
    return (E.cloneNode = E), E;
  }
  function rg(A, g = window.document) {
    const I = g[tg] || (g[tg] = new Set());
    for (let B = 0, Q = A.length; B < Q; B++) {
      const Q = A[B];
      I.has(Q) || (I.add(Q), g.addEventListener(Q, hg));
    }
  }
  function ag(A, g) {
  ...
  function cg(A, g, I, B) {
    ...
    } else A.addEventListener(g, I, "function" != typeof I && I);
  }
  function Dg(A, g, I) {
    if (!g)
      return I
  ...
  function hg(A) {
    ...
    const I = `$$${A.type}`,
      ...
      Q = A.currentTarget,
      C = (g) =>
        Object.defineProperty(A, "target", { configurable: !0, value: g }),
      E = () => {
        const B = g[I];
        if (B && !g.disabled) {
          const Q = g[`${I}Data`];
          if ((void 0 !== Q ? B.call(g, Q, A) : B.call(g, A), A.cancelBubble))
            return;
        }
        return (
          g.host &&
            "string" != typeof g.host &&
            !g.host._$host &&
            g.contains(A.target) &&
            C(g.host),
          !0
      ...
      V = () => {
        for (; E() && (g = g._$host || g.parentNode || g.host); );
      };
    if (
      ...
      const I = A.composedPath();
      C(I[0]);
      for (let A = 0; A < I.length - 2 && ((g = I[A]), E()); A++) {
        if (g._$host) {
          (g = g._$host), V();
          break;
        }
        if (g.parentNode === Q) break;
      }
    } else V();
    C(B);
  }
  function yg(A, g, I, B, Q) {
    ...
    if (
      ...
      if ("number" === C && (g = g.toString()) === I) return I;
      if (E) {
        let Q = I[0];
        Q && 3 === Q.nodeType
          ? Q.data !== g && (Q.data = g)
        ...
        I =
          "" !== I && "string" == typeof I
            ? (A.firstChild.data = g)
            : (A.textContent = g);
    } else if (null == g || "boolean" === C) I = Fg(A, I, B);
    else {
      if ("function" === C)
        return (
          uA(() => {
      ...
      if (Array.isArray(g)) {
        const C = [],
          V = I && Array.isArray(I);
        if (Gg(C, g, I, Q)) return uA(() => (I = yg(A, C, I, B, !0))), () => I;
        if (0 === C.length) {
          if (((I = Fg(A, I, B)), E)) return I;
        } else
          V
            ? 0 === I.length
              ? kg(A, C, B)
              : (function (A, g, I) {
                  ...
                  for (; E < Q || V < C; )
                    if (g[E] !== I[V]) {
                      ...
                      if (Q === E) {
                        const g =
                          C < B ? (V ? I[V - 1].nextSibling : I[C - V]) : i;
                        for (; V < C; ) A.insertBefore(I[V++], g);
                      } else if (C === V)
                        for (; E < Q; )
                          (e && e.has(g[E])) || g[E].remove(), E++;
  ...
  function Gg(A, g, I, B) {
    ...
    for (let C = 0, E = g.length; C < E; C++) {
      let E,
        ...
        i = I && I[A.length];
      if (null == V || !0 === V || !1 === V);
      else if ("object" == (E = typeof V) && V.nodeType) A.push(V);
      else if (Array.isArray(V)) Q = Gg(A, V, i) || Q;
      else if ("function" === E)
        if (B) {
          for (; "function" == typeof V; ) V = V();
          Q =
            Gg(A, Array.isArray(V) ? V : [V], Array.isArray(i) ? i : [i]) || Q;
        } else A.push(V), (Q = !0);
      else {
        const g = String(V);
        i && 3 === i.nodeType && i.data === g
          ? A.push(i)
  ...
  const Ng = Symbol("store-raw"),
    qg = Symbol("store-node"),
    Rg = Symbol("store-has"),
    Jg = Symbol("store-self");
  function dg(A) {
    let g = A[aA];
    if (
      !g &&
      (Object.defineProperty(A, aA, { value: (g = new Proxy(A, Sg)) }),
      !Array.isArray(A))
    ) {
      const I = Object.keys(A),
        B = Object.getOwnPropertyDescriptors(A);
      for (let Q = 0, C = I.length; Q < C; Q++) {
        const C = I[Q];
        B[C].get &&
  ...
  function ug(A, g = new Set()) {
    let I, B, Q, C;
    if ((I = null != A && A[Ng])) return I;
    if (!Mg(A) || g.has(A)) return A;
    if (Array.isArray(A)) {
      Object.isFrozen(A) ? (A = A.slice(0)) : g.add(A);
      for (let I = 0, C = A.length; I < C; I++)
        (Q = A[I]), (B = ug(Q, g)) !== Q && (A[I] = B);
    } else {
      Object.isFrozen(A) ? (A = Object.assign({}, A)) : g.add(A);
      const I = Object.keys(A),
        E = Object.getOwnPropertyDescriptors(A);
      for (let V = 0, i = I.length; V < i; V++)
        (C = I[V]),
          E[C].get || ((Q = A[C]), (B = ug(Q, g)) !== Q && (A[C] = B));
    }
    return A;
  }
  function fg(A, g) {
    let I = A[g];
    return (
      I || Object.defineProperty(A, g, { value: (I = Object.create(null)) }), I
    );
  }
  function Ug(A, g, I) {
    if (A[g]) return A[g];
    const [B, Q] = MA(I, { equals: !1, internal: !0 });
    return (B.$ = Q), (A[g] = B);
  }
  function Yg(A) {
    pA() && Ug(fg(A, qg), Jg)();
  ...
  const Sg = {
    get(A, g, I) {
      if (g === Ng) return A;
      if (g === aA) return I;
      if (g === DA) return Yg(A), I;
      const B = fg(A, qg),
        Q = B[g];
      let C = Q ? Q() : A[g];
      if (g === qg || g === Rg || "__proto__" === g) return C;
      if (!Q) {
    ...
    has: (A, g) =>
      ...
      g === Rg ||
      "__proto__" === g ||
      (pA() && Ug(fg(A, Rg), g)(), g in A),
    set: () => !0,
    deleteProperty: () => !0,
    ownKeys: function (A) {
      return Yg(A), Reflect.ownKeys(A);
    },
    getOwnPropertyDescriptor: function (A, g) {
      const I = Reflect.getOwnPropertyDescriptor(A, g);
      return I && !I.get && I.configurable && g !== aA && g !== qg
        ? (delete I.value, delete I.writable, (I.get = () => A[aA][g]), I)
        : I;
    },
  };
  function Lg(A, g, I, B = !1) {
    if (!B && A[g] === I) return;
    const Q = A[g],
      C = A.length;
    void 0 === I
      ? (delete A[g], A[Rg] && A[Rg][g] && void 0 !== Q && A[Rg][g].$())
      : ((A[g] = I), A[Rg] && A[Rg][g] && void 0 === Q && A[Rg][g].$());
    let E,
      V = fg(A, qg);
    if (
      ((E = Ug(V, g, Q)) && E.$(() => I), Array.isArray(A) && A.length !== C)
    ) {
      for (let g = A.length; g < C; g++) (E = V[g]) && E.$();
      (E = Ug(V, "length", C)) && E.$(A.length);
    }
    (E = V[Jg]) && E.$();
  }
  function pg(A, g) {
  ...
  function Kg(A, g, I = []) {
    ...
    if (g.length > 1) {
      ...
      const C = typeof B,
        E = Array.isArray(A);
      if (Array.isArray(B)) {
        for (let Q = 0; Q < B.length; Q++) Kg(A, [B[Q]].concat(g), I);
        return;
      }
      if (E && "function" === C) {
        for (let Q = 0; Q < A.length; Q++)
          B(A[Q], Q) && Kg(A, [Q].concat(g), I);
        return;
      }
      if (E && "object" === C) {
        const { from: Q = 0, to: C = A.length - 1, by: E = 1 } = B;
        for (let B = Q; B <= C; B += E) Kg(A, [B].concat(g), I);
        return;
      }
      if (g.length > 1) return void Kg(A[B], g, [B].concat(I));
      (Q = A[B]), (I = [B].concat(I));
    }
    let C = g[0];
    ("function" == typeof C && ((C = C(Q, I)), C === Q)) ||
      (void 0 === B && null == C) ||
      ((C = ug(C)),
      void 0 === B || (Mg(Q) && Mg(C) && !Array.isArray(C))
        ? pg(Q, C)
        : Lg(A, B, C));
  }
  function Hg(...[A, g]) {
  ...
  const mg = Symbol("store-root");
  function bg(A, g, I, B, Q) {
    const C = g[I];
    if (A === C) return;
    const E = Array.isArray(A);
    if (
      I !== mg &&
      (!Mg(A) || !Mg(C) || E !== Array.isArray(C) || (Q && A[Q] !== C[Q]))
    )
      return void Lg(g, I, A);
    if (E) {
      if (A.length && C.length && (!B || (Q && A[0] && null != A[0][Q]))) {
        ...
        const s = new Array(A.length),
          n = new Map();
        for (
          V = C.length - 1, i = A.length - 1;
          V >= E &&
          i >= E &&
          (C[V] === A[i] || (Q && C[V] && A[i] && C[V][Q] === A[i][Q]));
          V--, i--
        )
          s[i] = C[V];
        if (E > i || E > V) {
          for (I = E; I <= i; I++) Lg(C, I, A[I]);
          for (; I < A.length; I++) Lg(C, I, s[I]), bg(A[I], C, I, B, Q);
          return void (C.length > A.length && Lg(C, "length", A.length));
        }
        ...
        for (g = E; g <= V; g++)
          (e = C[g]),
            ...
            void 0 !== I &&
              -1 !== I &&
              ((s[I] = C[g]), (I = o[I]), n.set(t, I));
        for (I = E; I < A.length; I++)
          I in s ? (Lg(C, I, s[I]), bg(A[I], C, I, B, Q)) : Lg(C, I, A[I]);
      } else for (let g = 0, I = A.length; g < I; g++) bg(A[g], C, g, B, Q);
      return void (C.length > A.length && Lg(C, "length", A.length));
    }
    const V = Object.keys(A);
    for (let g = 0, I = V.length; g < I; g++) bg(A[V[g]], C, V[g], B, Q);
    const i = Object.keys(C);
    for (let g = 0, I = i.length; g < I; g++)
      void 0 === A[i[g]] && Lg(C, i[g], void 0);
  }
  function vg(A, g = {}) {
    const { merge: I, key: B = "id" } = g,
      Q = ug(A);
    return (A) => {
      if (!Mg(A) || !Mg(Q)) return Q;
      const g = bg(Q, { [mg]: A }, mg, I, B);
      return void 0 === g ? A : g;
    };
  }
  const Tg = ng("<span></span>", 2);
  var xg = (A) => {
    const g = fA(() => {
        if (1 == A.text.length) {
      ...
      B = fA(() =>
        (function (A, g, I) {
          ...
          return C;
        })(A.pen, A.offset, A.cellCount),
      ),
      Q = fA(() =>
        (function (A, g, I) {
          const B = Og(A.get("fg"), A.get("bold"), "fg-"),
            Q = Og(A.get("bg"), !1, "bg-");
          let C = I ?? "";
        ...
        uA(
          (g) => {
            const I = Q(),
              C = B();
            return (
              I !== g._v$ && ag(A, (g._v$ = I)), (g._v$2 = Dg(A, C, g._v$2)), g
            );
          },
  ...
  const Wg = ng('<span class="ap-line" role="paragraph"></span>', 2);
  var jg = (A) =>
    (() => {
              ...
              return (() => {
                if ("number" == typeof A.cursor) {
                  ...
                  for (
                    ...
                    g.push(Q), (I += Q.cellCount), B++;
                  }
                  if (B < A.segments.length) {
                    const Q = A.segments[B],
                      C = Q.charWidth;
                    let E = A.cursor - I;
                    const V = Math.floor(E / C);
                    E = V * C;
                    const i = Array.from(Q.text);
                    for (
                      V > 0 && g.push({ ...Q, text: i.slice(0, V).join("") }),
                        g.push({
                          ...Q,
                          text: i[V],
                          offset: I + E,
                        ...
                        V < i.length - 1 &&
                          g.push({
                            ...Q,
                            text: i.slice(V + 1).join(""),
                            offset: I + E + 1,
                            cellCount: Q.cellCount - C,
                          }),
                        B++;
                      B < A.segments.length;
              ...
              Ag(
                ...
                (function (...A) {
                    ...
                    return new Proxy(
                      {
                        ...
                        has(g) {
                          for (let I = A.length - 1; I >= 0; I--)
                            if (g in Bg(A[I])) return !0;
                          return !1;
                        },
                        keys() {
                          const g = [];
                          for (let I = 0; I < A.length; I++)
                            g.push(...Object.keys(Bg(A[I])));
                          return [...new Set(g)];
                        },
                      },
                      Ig,
                  ...
                  for (let g = A.length - 1; g >= 0; g--) {
                    const Q = A[g];
                    if (!Q) continue;
                    const C = Object.getOwnPropertyNames(Q);
                    for (let A = C.length - 1; A >= 0; A--) {
                      const g = C[A];
                      if ("__proto__" === g || "constructor" === g) continue;
                      const E = Object.getOwnPropertyDescriptor(Q, g);
                      if (B[g]) {
                        const A = I[g];
                        A &&
                          (E.get
                            ? A.push(E.get.bind(Q))
                            : void 0 !== E.value && A.push(() => E.value));
                      } else
                        B[g] = E.get
                          ? {
                              enumerable: !0,
                              configurable: !0,
                              get: Qg.bind((I[g] = [E.get.bind(Q)])),
                            }
                          : void 0 !== E.value
                            ? E
                            : void 0;
                  ...
                  for (let A = C.length - 1; A >= 0; A--) {
                    const g = C[A],
                      I = B[g];
                    I && I.get
                      ? Object.defineProperty(Q, g, I)
                      : (Q[g] = I ? I.value : void 0);
                  }
                  return Q;
                })(A),
              ),
  ...
  const Zg = ng(
    '<pre class="ap-terminal" aria-live="off" tabindex="0"></pre>',
    2,
  );
  var Xg = (A) => {
    const g = () => A.lineHeight ?? 1.3333333333,
      ...
      Q = fA(() => A.cursor?.[1]);
    return (() => {
      const g = Zg.cloneNode(!0),
        C = A.ref;
      return (
        "function" == typeof C ? wg(C, g) : (A.ref = g),
        lg(
          g,
          Ag(Eg, {
            get each() {
  ...
  var QI = (A) => {
    const g = (A) => (g) => {
      ...
      I = () =>
        "number" == typeof A.currentTime ? II(A.currentTime) : "--:--",
      B = () =>
        "number" == typeof A.remainingTime ? "-" + II(A.remainingTime) : I(),
      Q = fA(() =>
    ...
    return (
      ...
      (() => {
        const C = AI.cloneNode(!0),
          ...
          r = A.ref;
        return (
          "function" == typeof r ? wg(r, C) : (A.ref = C),
          lg(
            C,
            Ag(ig, {
              get when() {
              ...
              get children() {
                const I = _g.cloneNode(!0);
                return (
                  cg(I, "click", g(A.onPlayClick), !0),
                  lg(
                    I,
                    Ag(eg, {
                      get children() {
            ...
            Ag(ig, {
              ...
              get children() {
                ...
                return (
                  ...
                  uA((g) =>
                    Dg(B, { transform: `scaleX(${A.progress || 0}` }, g),
                  ),
                  I
                );
              },
          ...
          cg(s, "click", g(A.onHelpClick), !0),
          cg(n, "click", g(A.onFullscreenClick), !0),
          uA(() => C.classList.toggle("ap-seekable", !!A.isSeekable)),
          C
        );
      })()
    );
  };
  rg(["click", "mousedown", "mousemove"]);
  const CI = ng(
    '<div class="ap-overlay ap-overlay-error"><span>💥</span></div>',
    4,
  );
  var EI = (A) => CI.cloneNode(!0);
  const VI = ng(
    '<div class="ap-overlay ap-overlay-loading"><span class="ap-loader"></span></div>',
    4,
  );
  var iI = (A) => VI.cloneNode(!0);
  const eI = ng(
  ...
  var oI = (A) =>
    (() => {
      ...
      return (
        lg(I, () => A.message),
        uA((g) => Dg(I, { "font-family": A.fontFamily }, g)),
        g
      );
    })();
  const tI = ng(
  ...
  rg(["click"]);
  const nI = ng("<li><kbd>space</kbd> - pause / resume</li>", 4),
    rI = ng(
    ...
    lI = ng(
      '<div class="ap-overlay ap-overlay-help"><div><div><p>Keyboard shortcuts</p><ul><li><kbd>f</kbd> - toggle fullscreen mode</li><li><kbd>?</kbd> - toggle this help popup</li></ul></div></div></div>',
      18,
    );
  var hI = (A) =>
    (() => {
      const g = lI.cloneNode(!0),
        I = g.firstChild,
        B = I.firstChild.firstChild.nextSibling,
        Q = B.firstChild;
      var C;
      return (
        cg(
        ...
        uA((I) => Dg(g, { "font-family": A.fontFamily }, I)),
        g
      );
    })();
  rg(["click"]);
  const yI = ng('<div class="ap-wrapper" tabindex="-1"><div></div></div>', 4);
  var GI = (A) => {
    const g = A.logger,
      I = A.core,
      B = A.autoPlay,
    ...
    function H(A) {
      null === A || B || C({ lines: A.lines, cursor: A.cursor });
    }
    const m = new Promise((A) => {
      L = A;
    });
    I.addEventListener("ready", (A) => {
      let { isPausable: g, isSeekable: I, poster: B } = A;
      C({ isPausable: g, isSeekable: I }), H(B), L();
    }),
      I.addEventListener("metadata", (A) => {
        let {
          cols: g,
          rows: I,
          duration: B,
        ...
        UA(() => {
          K({ cols: g, rows: I }), a(B), k(Q), D(E), H(C);
        });
      }),
    ...
    I.addEventListener("ended", (A) => {
      let { message: I } = A;
      UA(() => {
        V(!1), p(), void 0 !== I && (t(I), e("info"));
      }),
        g.debug(`view: render count: ${b}`);
    }),
      ...
      I.addEventListener("terminalUpdate", () => {
        void 0 === R && (R = requestAnimationFrame(T));
      });
    const v = () => {
      (S = new ResizeObserver(
        (function (A, g) {
          ...
          C({ containerW: u.offsetWidth, containerH: u.offsetHeight }),
            u.dispatchEvent(new CustomEvent("resize", { detail: { el: f } }));
        }, 10),
      )),
        S.observe(u);
    };
    ...
    const T = async () => {
        ...
        UA(() => {
          void 0 !== A.lines &&
            ...
            void 0 !== A.cursor && C("cursor", vg(A.cursor)),
            C("cursorHold", !0);
        }),
          (R = void 0),
          (b += 1);
      ...
      x = fA(() => {
        const g = Q.charW * F() + Q.bordersW,
          I = Q.charH * N() + Q.bordersH;
        let B = A.fit ?? "width";
        if ("both" === B || Q.isFullscreen) {
          B = Q.containerW / (Q.containerH - q()) > g / I ? "height" : "width";
        }
        if (!1 === B || "none" === B) return {};
        if ("width" === B) {
          const A = Q.containerW / g;
          return { scale: A, width: Q.containerW, height: I * A + q() };
        }
        if ("height" === B) {
      ...
      Z = (A) => {
        if (!(A.altKey || A.metaKey || A.ctrlKey)) {
          ...
          else if ("," == A.key) I.step(-1), $();
          else if ("." == A.key) I.step(), $();
          else if ("f" == A.key) W();
      ...
      gA = () => {
        clearInterval(M), C("blink", !0);
      },
      IA = (A) => {
        clearTimeout(J), A && (J = setTimeout(() => IA(!1), 2e3)), l(A);
      },
      BA = fA(() => {
        const g = A.theme || "auto/asciinema";
        return "auto/" === g.slice(0, 5)
          ? { name: g.slice(5), colors: G() }
          : { name: g };
      }),
      QA = () => {
        m.then(() => I.play());
      ...
      VA = (() => {
        const g = yI.cloneNode(!0),
          I = g.firstChild;
        "function" == typeof u ? wg(u, g) : (u = g),
          g.addEventListener("webkitfullscreenchange", O),
          g.addEventListener("fullscreenchange", O),
          (g.$$mousemove = X),
          (g.$$keydown = Z);
        return (
          "function" == typeof f ? wg(f, I) : (f = I),
          (I.$$mousemove = () => IA(!0)),
          ...
          uA(
            (B) => {
              const Q = !!(!0 === A.controls || ("auto" === A.controls && w())),
                C = `ap-player asciinema-player-theme-${BA().name}`,
                E = (() => {
                  const g = {};
                  (!1 !== A.fit && "none" !== A.fit) ||
              ...
              return (
                Q !== B._v$ && g.classList.toggle("ap-hud", (B._v$ = Q)),
                C !== B._v$2 && ag(I, (B._v$2 = C)),
                (B._v$3 = Dg(I, E, B._v$3)),
                B
              );
            },
            { _v$: void 0, _v$2: void 0, _v$3: void 0 },
  ...
  function kI(A, g) {
    ...
    let C;
    const E = sg(() => ((C = Ag(GI, Q)), C), g);
    return { el: C, dispose: E };
  }
  rg(["keydown", "mousemove"]);
  const FI = [
      "autoPlay",
      "autoplay",
      "cols",
    ...
    (A.create = function (A, g) {
      ...
      const Q = B.logger ?? new I(),
          ...
          (function (A) {
            ...
            const I = Object.fromEntries(
              Object.entries(A).filter((A) => {
                let [g] = A;
                return FI.includes(g);
              }),
            );
            return (I.autoPlay ??= I.autoplay), (I.speed ??= 1), { ...I, ...g };
          })(B, { logger: Q }),
        ),
        { el: E, dispose: V } = kI(
          C,
        ...
        e = {
          el: E,
          dispose: V,
          getCurrentTime: () => i.then(C.getCurrentTime.bind(C)),
          getDuration: () => i.then(C.getDuration.bind(C)),
          play: () => i.then(C.play.bind(C)),
          pause: () => i.then(C.pause.bind(C)),
          seek: (A) => i.then(() => C.seek(A)),
